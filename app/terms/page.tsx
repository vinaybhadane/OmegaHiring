...
export const metadata: Metadata = {
  title: "Terms & Conditions | OmegaHiring",
  description: "Read OmegaHiring's Terms & Conditions — the rules and guidelines governing use of our remote jobs and career platform.",
      ...
      <div className="container-lg max-w-3xl mx-auto">
        ...
        <div className="card p-8 space-y-8 text-slate-600 leading-relaxed">
          ...
          <section>
            ...
            <p>By accessing and using OmegaHiring (careers.abhyasmitra.in), you agree to be bound by these Terms & Conditions. If you do not agree with any part of these terms, you must not use this platform.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">2. About the Platform</h2>
            <p>OmegaHiring is a career portal operated by AbhyasMitra that connects job seekers with remote and work-from-home opportunities. We act as an intermediary between applicants and hiring organizations and do not guarantee employment.</p>
          </section>
          ...
          <section>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-4">
              <p className="text-amber-800 font-semibold text-sm">
                ⚠️ Important: Any payment made on the OmegaHiring platform is non-refundable.
              </p>
            </div>
            <p className="mb-3">To maintain a serious and efficient hiring process, OmegaHiring charges a small application processing fee. This fee helps us:</p>
          ...
          <section>
            ...
            <p>OmegaHiring does not guarantee job placement, interview calls, or employment outcomes. Selection depends entirely on the requirements of the hiring organizations. We process and forward applications but do not control final hiring decisions.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">6. Intellectual Property</h2>
            <p>All content on OmegaHiring — including logos, text, graphics, and code — is the property of AbhyasMitra. You may not reproduce, copy, or use any content without prior written permission.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-3">7. Limitation of Liability</h2>
            <p>OmegaHiring shall not be held liable for any direct, indirect, incidental, or consequential damages arising from use of our platform, including but not limited to loss of income, employment opportunity, or data. We provide our services "as is" without warranties of any kind.</p>
          </section>
          ...
          <section>
            ...
            <p>OmegaHiring reserves the right to modify these Terms & Conditions at any time. Changes will be effective immediately upon posting. Continued use of the platform constitutes acceptance of revised terms.</p>
          </section>
